...
def saveResult(resultList):
    f = open("opencfu_clustering_result.csv", 'w+')
...
# get count answer group parameter
...
#           continue
        ...
        # tmp = 'DL147-3B'
        filename = tmp
        fn2 = pth2 + '%s_openCFU_result_b.png.csv' % filename
